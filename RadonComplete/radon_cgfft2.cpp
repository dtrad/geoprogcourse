...
float radon_cgfft(complex *d2, complex **L, complex *RC, complex *m2, int nh, int nq, 
                  int nf2, float *Wm, float *Cd, float eps, int itercg, float step){
  ...
  while ( k < itercg ){
    ...
    if (stopcriteria(gcv,rho,normrhs,nh,nq,k,GCV)){
		...
		complex *fc, complex *gc)
{
  ...
  /*
     ...
     based on original code from Mauricio Sacchi, adapted by Daniel Trad
