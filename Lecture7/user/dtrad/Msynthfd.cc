...
// Daniel Trad, March, 2016
// Zhan Niu, fixed 8 order May, 2017
...
{   
    ...
    int method;
    par.get("method",method,2); // eight order, more precise
    ...
    Fdmodb* fdmodb = new Fdmodb(nx,nz,nt,nb,nbup,ng,ns,dx,dz,dt,&(vels[0]),fm,amp, method); 
